...
import 'package:restaurant_app/src/resources/models/background_colors.dart';

import 'dart:math' as math;

import 'package:restaurant_app/src/resources/models/food.dart';
import 'package:restaurant_app/src/resources/models/menu.dart';
import 'package:restaurant_app/src/widgets/animated_circle.dart';
import 'package:restaurant_app/src/widgets/cart_button.dart';
import 'package:restaurant_app/src/widgets/custom_app_bar.dart';
import 'package:restaurant_app/src/widgets/food_image.dart';
import 'package:restaurant_app/src/widgets/item_card.dart';
import 'package:restaurant_app/src/widgets/rectangle_indicator.dart';
import 'package:restaurant_app/src/widgets/shadows.dart';
...
class _MenuPagerState extends State<MenuPager> with TickerProviderStateMixin {
  ...
  int _counter = 0;
  int _cartQuantity = ShoppingCartController.to.items.length;
  AnimationController controller, scaleController;
  Animation<double> scaleAnimation;
  bool firstEntry = ShoppingCartController.to.items.length < 0;
            ...
            child: new Stack(
              children: <Widget>[
                ...
                new CartButton(
                    ...
                    addToCart: () {
                      shoppingCartController.addItem(food);
                ...
                child: new ScaleTransition(
                  ...
                  child: new Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Colors.amber),
                    child: new Text('${ShoppingCartController.to.getTotalCount()}',
